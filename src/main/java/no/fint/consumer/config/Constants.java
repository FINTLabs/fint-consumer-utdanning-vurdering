...
;
    ...
    public static final String CACHE_INITIALDELAY_FRAVAR = "${fint.consumer.cache.initialDelay.fravar:1500000}";
    public static final String CACHE_FIXEDRATE_FRAVAR = "${fint.consumer.cache.fixedRate.fravar:900000}";
    
    public static final String CACHE_INITIALDELAY_FRAVARSOVERSIKT = "${fint.consumer.cache.initialDelay.fravarsoversikt:1600000}";
    public static final String CACHE_FIXEDRATE_FRAVARSOVERSIKT = "${fint.consumer.cache.fixedRate.fravarsoversikt:900000}";
    
    public static final String CACHE_INITIALDELAY_FRAVARSREGISTRERING = "${fint.consumer.cache.initialDelay.fravarsregistrering:1700000}";
    public static final String CACHE_FIXEDRATE_FRAVARSREGISTRERING = "${fint.consumer.cache.fixedRate.fravarsregistrering:900000}";
    
    public static final String CACHE_INITIALDELAY_HALVARSFAGVURDERING = "${fint.consumer.cache.initialDelay.halvarsfagvurdering:1800000}";
    public static final String CACHE_FIXEDRATE_HALVARSFAGVURDERING = "${fint.consumer.cache.fixedRate.halvarsfagvurdering:900000}";
    
    public static final String CACHE_INITIALDELAY_HALVARSORDENSVURDERING = "${fint.consumer.cache.initialDelay.halvarsordensvurdering:1900000}";
    ...
    public static final String CACHE_INITIALDELAY_KARAKTERHISTORIE = "${fint.consumer.cache.initialDelay.karakterhistorie:2000000}";
    public static final String CACHE_FIXEDRATE_KARAKTERHISTORIE = "${fint.consumer.cache.fixedRate.karakterhistorie:900000}";
    
    public static final String CACHE_INITIALDELAY_KARAKTERVERDI = "${fint.consumer.cache.initialDelay.karakterverdi:2100000}";
    public static final String CACHE_FIXEDRATE_KARAKTERVERDI = "${fint.consumer.cache.fixedRate.karakterverdi:900000}";
    
    public static final String CACHE_INITIALDELAY_SENSOR = "${fint.consumer.cache.initialDelay.sensor:2200000}";
    public static final String CACHE_FIXEDRATE_SENSOR = "${fint.consumer.cache.fixedRate.sensor:900000}";
    
    public static final String CACHE_INITIALDELAY_SLUTTFAGVURDERING = "${fint.consumer.cache.initialDelay.sluttfagvurdering:2300000}";
    public static final String CACHE_FIXEDRATE_SLUTTFAGVURDERING = "${fint.consumer.cache.fixedRate.sluttfagvurdering:900000}";
    
    public static final String CACHE_INITIALDELAY_SLUTTORDENSVURDERING = "${fint.consumer.cache.initialDelay.sluttordensvurdering:2400000}";
    ...
    public static final String CACHE_INITIALDELAY_UNDERVEISFAGVURDERING = "${fint.consumer.cache.initialDelay.underveisfagvurdering:2500000}";
    ...
    public static final String CACHE_INITIALDELAY_UNDERVEISORDENSVURDERING = "${fint.consumer.cache.initialDelay.underveisordensvurdering:2600000}";
    ...
    public static final String CACHE_INITIALDELAY_VURDERING = "${fint.consumer.cache.initialDelay.vurdering:2700000}";
